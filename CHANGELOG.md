...
**version 1.2.10**    
- добавлен лимит времени выполнения регулярки разбора адресов страниц для показа уведомления о cookies.    

**version 1.2.9**    
- исправление csfr на страницах настроек модуля.    

**version 1.2.8**    
- исправление ошибки проверки регулярок.    

**version 1.2.7**    
- добавлена опция записи журнала согласий принятия или отклонения cookies; - фикс передачи SITE_ID для определения шаблона компонента.    
