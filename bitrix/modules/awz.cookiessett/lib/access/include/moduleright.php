...
use Awz\Cookiessett\Access\Custom\ComponentConfig;
                ...
                window.awz_right_dialog = {
                    ...
                    reloadItems: function(items, event){
                        ...
                        items.forEach(function(itm){
                            if(itm.getEntityId()==='user' || itm.getEntityType()==='awzcookiessett-user'){
                                let itmEv = {
                                    type: 'users',
                                    id: 'U'+itm.getId(),
                                    key: 'U'+itm.getId(),
                            ...
                            }else if(itm.getEntityType()==='awzcookiessett-group'){
                                let itmEv = {
                                    type: 'groups',
                                    id: 'G'+itm.getId(),
                                    key: 'G'+itm.getId(),
                    ...
                    load: function(groupKey, options){
                        ...
                        if(groupData.hasOwnProperty('members')){
                            for(k in groupData['members']){
                                ...
                                if(itm.type==='users'){
                                    preselectedItems.push(['awzcookiessett-user',itm.id]);
                                }
                                else if(itm.type==='awzcookiessett-user'){
                                    preselectedItems.push(['awzcookiessett-user',itm.id]);
                                }
                                else if(itm.type==='awzcookiessett-group'){
                                    preselectedItems.push(['awzcookiessett-group',itm.id]);
                                }
                        ...
                        this.dialog = new BX.UI.EntitySelector.Dialog({
                            ...
                            entities: [
                                {
                                    id: 'awzcookiessett-user',
                                    options: {},
                                    dynamicLoad: true,
                                    dynamicSearch: true,
                                },
                                {
                                    id: 'awzcookiessett-group',
                                    options: {},
                                    dynamicLoad: true,
                                    dynamicSearch: true,
                                },
